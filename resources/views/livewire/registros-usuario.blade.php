<main>
    <h1 class=" font-bold text-2xl mt-6">Registros de : <span class="text-usuario-letra"> {{ $user->name }} </span>
    </h1>
    <h1 class=" font-bold text-2xl ">Departamento : <span class="text-usuario-letra">
            {{ $user->dependencia->dep_nombre }} </span>
    </h1>
    <!-- Start coding here -->
